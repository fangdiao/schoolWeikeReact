...
export default {
  ...
  //学生登录
  'studentLogin': createAction('STUDENT_LOGIN', reqData => requestLoginIn('/weike/student/login', reqData), reqData => reqData),
  //老师登录
  'teacherLogin': createAction('TEACHER_LOGIN', reqData => requestLoginIn('/weike/teacher/login', reqData), reqData => reqData),
  //退出登录
  'logOut': createAction('LOG_OUT'),
  //获取图片验证码
  'getImgCode': createAction('GET_IMG_CODE', reqData => requestImg('/weike/getVerifyCode'), reqData => reqData),
  //老师获取邮箱验证码
  'teacherEmailCode': createAction('TEACHER_EMAIL_CODE', reqData => request('/weike/teacher/GetVerifyCodeForRegister', reqData), reqData => reqData),
  //学生获取邮箱验证码
  'studentEmailCode': createAction('STUDENT_EMAIL_CODE', reqData => request('/weike/student/GetVerifyCodeForRegister', reqData), reqData => reqData),
  //学生注册
  ...
  //学生修改密码
  'studentChangePW': createAction('TEACHER_CHANGE_PW', reqData => request('/weike/student/FindPassword', reqData, 'post'), reqData => reqData),
  //老师修改密码
